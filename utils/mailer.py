...
class ThreadMailer(object):
    ...
    def sendMessage(self, message):
        result = self.threadPool.apply_async(self.mailer.send, args=(message, ))
        return result.get()


def main():
    message = Message()
    message.From = "dragondjf@163.com"
    message.To = ["465398889@qq.com", "dingjiangfeng@beyondsoft.com"]
